...
def _patch_all() -> None:
    ...
    st.build_signal_trace_from_spec = _wrap("signal_trace.build_full", st.build_signal_trace_from_spec)
...
def main() -> None:
    ...
    try:
        ...
        dbg_mark("signal_trace.fetch_attempt", n=1)
        ...
        dbg_mark("signal_trace.fetch_attempt", n=2)
        fetch_signal_trace_bundle(
            run_id=run_id,
            variant_key=variant,
            from_ms=from_ms,

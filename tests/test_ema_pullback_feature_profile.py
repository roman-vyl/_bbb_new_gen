...
from research.strategies.ema_pullback.feature_profile import (
    EMA_PULLBACK_1H_20_200_500_FEATURE_PROFILE,
    EMA_PULLBACK_1H_20_200_500_PROFILE_ID,
...
def test_stage7_feature_profile_exists() -> None:
    profile = EMA_PULLBACK_1H_20_200_500_FEATURE_PROFILE
    assert profile.profile_id == EMA_PULLBACK_1H_20_200_500_PROFILE_ID

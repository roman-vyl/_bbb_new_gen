# research-api-market-ema-window Specification

## Purpose

Canonical per-period chart overlay EMA with in-process cache, extension, and window slicing. One period per request; frontend never receives warmup bars.
## Requirements

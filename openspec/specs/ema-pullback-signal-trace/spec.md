...
Signal Trace contract for `ema_pullback`: per-bar pipeline gates, blocker/setup internals, exit-management diagnostics, and component-agnostic `component_events`. Extended by trend-strength-episode-blocker (2026-06-02) and anchor-stack-width-setup (2026-06-03).
## Requirements

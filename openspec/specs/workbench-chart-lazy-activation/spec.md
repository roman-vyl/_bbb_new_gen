# workbench-chart-lazy-activation Specification

## Purpose

Gate chart-heavy Workbench IO (`chart-bundle`, initial `signal-trace`, chart-only auxiliary overlays) until Chart tab activation while keeping run list and report loading eager.
